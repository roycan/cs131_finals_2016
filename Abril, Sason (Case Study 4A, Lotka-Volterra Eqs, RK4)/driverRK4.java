...
public class driverRK4{
    private static Double ti, tf, a, b, c, d, h, xinit, yinit;
    private static Double[] x, y, t;

    public void init(Double ti, Double tf, Double a, Double b, Double c, Double d, Double h, Double x, Double y){
        driverRK4.ti = ti;
        driverRK4.tf = tf;
        driverRK4.a = a;
		driverRK4.b = b;
	...
	public static void main(){
		...
		*/
		...
		Sys2ODEsRK4.f(n, t, h, x, y, a, b, c, d);
	FileWriter pp = null;
	try{
