...
public class Sys2ODEsRK4{
	...
	public ArrayList<ArrayList<Double>> Solve(double a, double b, double h, double x1, double y1){
		...
		for(int i = 0; i < n; i++) {
			...
			t.add(t.get(i) + h); 
			tm = t.get(i) + h/2; 
			Kx1 = ODE1.Val(t.get(i),x.get(i),y.get(i)); 
			System.out.println("\tKx1: "+Kx1);
			Ky1 = ODE2.Val(t.get(i),x.get(i),y.get(i)); 
			System.out.println("\tKy1: "+Ky1);
			Kx2 = ODE1.Val(tm, x.get(i)+(h/2)*Kx1, + y.get(i)+(h/2)*Ky1); 
			System.out.println("\tKx2: "+Kx2);
			Ky2 = ODE2.Val(tm, x.get(i)+(h/2)*Kx1, + y.get(i)+(h/2)*Ky1);
			System.out.println("\tKy1: "+Ky2);
			Kx3 = ODE1.Val(tm, x.get(i)+(h/2)*Kx2, + y.get(i)+(h/2)*Ky2);
			System.out.println("\tKx3: "+Kx3);
			Ky3 = ODE2.Val(tm, x.get(i)+(h/2)*Kx2, + y.get(i)+(h/2)*Ky2);
			System.out.println("\tKy3: "+Ky3);
			Kx4 = ODE1.Val(t.get(i+1), x.get(i)+h*Kx3, + y.get(i)+h*Ky3);
			System.out.println("\tKx4: "+Kx4);
			Ky4 = ODE2.Val(t.get(i+1), x.get(i)+h*Kx3, + y.get(i)+h*Ky3);
